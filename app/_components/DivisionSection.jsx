function DivisionSection({ title, precis, children }) {
    return (
        <div className="items-start flex flex-none flex-col flex-nowrap gap-6 h-min justify-center overflow-hidden px-10 max-[1199px]:px-6 py-10 relative w-full">
            ...
            {precis && <div className="outline-none flex flex-col justify-start shrink-0 flex-none h-auto relative whitespace-pre-wrap w-full">
